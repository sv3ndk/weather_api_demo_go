...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.7.3
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/dynamodbstreams v1.19.2 // indirect
